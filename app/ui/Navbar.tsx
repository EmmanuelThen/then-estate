...
const Navbar = (props: Props) => {
    return (
        <nav className="flex item-center max-h-[35px] fixed w-full backdrop-blur-2xl shrink-0 border-b-[0.5px] z-[999]" aria-label="Nav bar">
            {/* Logo div */}
            <div className=''>
            ...
            {/* Log in/Sign up */}
            <div className='flex items-center gap-2 h-[35px] mr-2'>
                <Link
