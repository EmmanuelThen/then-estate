                ...
                <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                    ...
                    <div className="text-center pb-12 md:pb-16">
                        ...
                        <h1
                            ...
                            data-aos-delay={150}
                        >
                            Home for all of your <br className="max-lg:hidden" />
                            real estate needs
                        </h1>
                        <div className="max-w-3xl mx-auto">
                            <p
                                ...
                                data-aos-delay={300}
                            >
                                Thenestate, where we simplify the path to your real estate investment journey.
                                Your real estate success story starts here.
                            </p>
                            <div className="relative before:absolute before:inset-0 before:border-y before:[border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1]">
                                <div
                                    className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center gap-2"
                                    data-aos="zoom-y-out"
                                    data-aos-delay={450}
                                >
                                    ...
                                    <div className="sm:ml-4 sm:w-auto">
                                        <PrimaryButton
                                            color={'primary'}
                                            size={'lg'}
                                            radius={'md'}
