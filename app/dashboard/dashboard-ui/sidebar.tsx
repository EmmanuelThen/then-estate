                                    ...
                                    title={
                                        item.icon ? (
                                            <div className={"flex h-11 items-center gap-2 px-2 py-1.5"}>
                                                {/* Accordion title which is (community) */}
                                                <Icon
                                                    className={cn(
                                                        "text-default-500 {group-data-[selected=true]:text-primary}",
                                                        iconClassName,
                                                    ...
                                                    width={24}
                                                />
                                                <span className="text-small font-medium text-default-500 {group-data-[selected=true]:text-primary}">
                                                    {item.title}
                                                </span>
                                            </div>
                                        ) : (
                                ...
                                >
                                    ...
                                    {item.items && item.items?.length > 0 ? (
                                        <Listbox
                                            className={"mt-0.5"}
                                            classNames={{
                                                list: cn("border-l border-default-200 pl-4 text-default-500"),
                                            }}
                                            items={item.items}
                                            variant="flat"
                                        >
        ...
        return (
            ...
            <Listbox
                ...
                itemClasses={{
                    ...itemClasses,
                    base: cn(
                        "px-3 min-h-11 rounded-large h-[44px] data-[selected=true]:bg-default-200",
                        itemClasses?.base,
                    ),
                    title: cn(
